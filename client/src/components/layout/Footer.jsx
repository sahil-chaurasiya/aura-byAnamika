  ...
  const footerColumns = [
    {
      ...
      links: [
        ...
        { label: 'Women', to: `/shop?category=${encodeURIComponent('Women')}` },
        { label: 'Shop by Occasion', to: `/shop?category=${encodeURIComponent('Shop by Occasion')}` },
      ],
    },
    {
      title: 'Accessories',
      links: [
        { label: 'Dupattas', to: `/shop?category=${encodeURIComponent('Dupattas')}` },
        { label: 'Jewellery', to: `/shop?category=${encodeURIComponent('Jewellery')}` },
        { label: 'Potli Bags', to: `/shop?category=${encodeURIComponent('Potli Bags')}` },
        { label: 'Belts', to: `/shop?category=${encodeURIComponent('Belts')}` },
      ],
    },
    {
      title: 'Services',
